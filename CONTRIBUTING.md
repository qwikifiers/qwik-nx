...
- Run `npm publish ./dist/packages/qwik-nx` in Terminal 2
- Run `npm publish ./dist/packages/add-nx-to-qwik` in Terminal 2
- Run `npm publish ./dist/packages/create-qwik-nx` in Terminal 2
